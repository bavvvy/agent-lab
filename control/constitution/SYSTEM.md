...
- Bootstrap export artifact must exist ONLY at `control/bootstrap/BOOTSTRAP_EXPORT.txt`
...
1. Overwrite `control/bootstrap/BOOTSTRAP_EXPORT.txt`.
...
3. Insert full unmodified contents of:
   - `control/constitution/SYSTEM.md`
   - `control/bootstrap/CONTEXT_BOOTSTRAP.md`
   - `control/bootstrap/system_config.yaml`
4. Do NOT dump full `control/constitution/ARCHITECTURE.md` into bootstrap export.
5. Preserve formatting exactly.
6. Confirm only `control/bootstrap/BOOTSTRAP_EXPORT.txt` changed.
...
3. Update `control/constitution/SYSTEM.md` to reflect current layered architecture and invariants.
4. Reconcile outdated references.
5. Regenerate `control/bootstrap/BOOTSTRAP_EXPORT.txt`.
6. Do NOT run npm.
...
1. Generate `control/bootstrap/BOOTSTRAP_EXPORT.txt`.
2. Use current `control/constitution/SYSTEM.md` and current repository structure references.
3. Do NOT modify `control/constitution/SYSTEM.md`.
...
3. Ensure the only bootstrap artifact written is `control/bootstrap/BOOTSTRAP_EXPORT.txt`.
